...
const columns = [
  ...
  { Header: 'Memoria', accessor: 'memorySize' },
  { Header: 'Memoria (%)', accessor: 'memoryPercentage' },
];

const requestsColumns = [
  { Header: 'PID', accessor: 'pid' },
  { Header: 'Llamada', accessor: 'call' },
  { Header: 'Tamaño', accessor: 'size' },
...
const columnsTop = [
  { Header: 'PID', accessor: 'pid' },
  { Header: 'Nombre', accessor: 'name' },
  { Header: 'Memoria', accessor: 'size' },
  { Header: 'Memoria (%)', accessor: 'sizePor' },
];
